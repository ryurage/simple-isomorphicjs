...
function PopupWindow_isClicked(e){
	if(this.divName != null){
		if(this.use_layers){
			...
			//alert("t.id:"+this.id + "\ndivName:" + this.divName + "\nparentNode:" + document.all[this.divName].value+"\nthis.id: "+this.name);
			...
			if (str.search(/cpMonthNavigation/) >= 0){
				return true;
			}else{
				return false;
			}
...
function CP_getCalendar(){
	...
	if(this.type == "WINDOW"){
		...
		result += '<TR><TD ALIGN=CENTER>\n';result += '<CENTER>\n';}if(this.displayType=="date" || this.displayType=="week-end"){
			...
			if(this.isShowNavigationDropdowns){
				...
				if(this.isShowYearNavigation){
					result += '<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="10"><A id="prev" CLASS="'+this.cssPrefix+'cpMonthNavigation" HREF="'+refreshLink+'('+this.index+','+last_month+','+last_month_year+');">&lt;</A></TD>';
					result += '<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="58"><SPAN CLASS="'+this.cssPrefix+'cpMonthNavigation">'+this.monthNames[month-1]+'</SPAN></TD>';
					result += '<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="10"><A id="next" CLASS="'+this.cssPrefix+'cpMonthNavigation" HREF="'+refreshLink+'('+this.index+','+next_month+','+next_month_year+');">&gt;</A></TD>';
					result += '<TD CLASS="'+this.cssPrefix+'cpMonthNavigation" WIDTH="10">&nbsp;</TD>';
		...
		if(this.disabledDatesExpression!=""){
			var ds=""+now.getFullYear()+LZ(now.getMonth()+1)+LZ(now.getDate());eval("disabled=("+this.disabledDatesExpression+")");
		}
